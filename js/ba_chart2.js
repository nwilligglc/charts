...
var intro_TP = "The annual phosphorus loads drive Central Basin hypoxia (i.e., low oxygen conditions that can cause dead zones), based on modeling. Therefore, targets to address hypoxia focus on annual loads from all tributaries. Twelve priority watersheds were identified and assigned with a target to reduce annual total phosphorus (TP) load by 40 percent of the 2008 load. Click on the watershed of interest to see available data.";
...
var narratives = {
    ...
    "Huron River": "The Huron River watershed is located on the south shore of Lake Erie between Toledo and Cleveland, in Huron, Erie, Seneca, Richland and Crawford counties.  The Huron River is 59.7 miles (96 km) long and the watershed covers 403 square miles (1,044 km<sup>2</sup>).  The East Branch serves as the public drinking water supply for the City of Norwalk, and The Village of Monroeville draws its water supply from the West Branch Huron River.  Land use is primarily dedicated to agricultural activities with approximately 74 percent cropland, 15 percent woodland, and 3 to 11 percent urban and other land uses.",
    ...
    "Toussaint Creek": "<i>*CONTENT UNDER DEVELOPMENT.</i>",
